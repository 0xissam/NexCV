...
const handleAddLanguage = () => {
  ...
  // Function to handle removing languages
  ...
  // Function to handle changing languages
  ...
  const Proxy =
    "https://mycoreproxy-74d7d6780461.herokuapp.com/https://nexapi-2e84832bb07e.herokuapp.com/cv/generate-pdf";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:3000/cv/generate-pdf",
        formData,
        {
          responseType: "blob",
        }
    ...
    <>
      <div className="container">
        <form onSubmit={handleSubmit}>
          <div className="form-group add-hobby mt-5">
            {/* <h2>Chose the Theme</h2> */}
            <div className="block-container shadow-none">
              <div className="form-group ">
                <label htmlFor="templateSelect">Chose a Template:</label>
                <select
                  id="templateSelect"
                  name="template"
                ...
                {formData.education.map((edu, index) => (
                  <div key={index} className="new-education mb-3">
                    ...
                    <div className="d-flex mt-2">
                      <button
                        type="button"
                        className="btn btn-soft-primary me-2 mr-2"
          ...
          {/* Languages Section */}
          <div className="form-group add-lang mt-4">
            <h2>Add Languages</h2>
            <div className="block-container shadow-none">
              <div className="all-languages">
                {formData.languages.map((language, index) => (
                  <div key={index} className="new-languages mb-3">
                    <div className="form-group">
